    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Только латинские буквы, цифры, подчёркивание и дефис.', regex='^[\\w.@+-]+\\Z')])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'author'), name='users_subscription_user_author_pair_unique'),
        ),
    ]
